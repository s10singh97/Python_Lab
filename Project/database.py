...
conn.execute("CREATE TABLE IF NOT EXISTS histories(id integer, screenname text, positive float, negative float, neutral float, transacted datetime default CURRENT_TIMESTAMP)")
